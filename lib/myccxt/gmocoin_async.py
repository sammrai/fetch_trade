...
#                 'ERR-5003': RateLimitExceeded,  # The API usage limits are exceeded.
    ...
    async def fetch_balance(self, params={}):
        ...
        response = await self.privateGetAccountAssets(params)
        # {
        #   "status": 0,
        #   "data": [
        #     {
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        if 'settlePosition' in params:
            ...
            response = await self.privatePostCloseOrder(self.extend(request, params))
        else:
    ...
    async def create_close_orders(self, symbol, type, side, amount, price=None, params={}):
        await self.load_markets()
        request = {
            'symbol': self.market_id(symbol),
            'side': side.upper(),
        ...
        response = await self.privatePostCloseBulkOrder(self.extend(request, params))
        # {
        #   "status": 0,
        #   "data": "637000",
        #   "responsetime": "2019-03-19T02:15:06.108Z"
    ...
    async def cancel_all_orders(self, symbol=None, params={}):
        ...
        response = await self.privatePostCancelBulkOrder(self.extend(request, params))
        # {
        #     "status": 0,
        #     "data": [637000,637002],
        #     "responsetime": "2019-03-19T01:07:24.557Z"
    ...
    async def fetch_orders(self, symbol=None, since=1, limit=100, params={}):
        if symbol is None:
        ...
        response = await self.privateGetActiveOrders(self.extend(request, params))
        # {
        #   "status": 0,
        #   "data": {
        #     "pagination": {
    ...
    async def fetch_open_orders(self, symbol=None, since=1, limit=100, params={}):
    ...
    async def fetch_my_trades(self, symbol=None, since=1, limit=100, params={}):
        if symbol is None:
        ...
        response = await self.privateGetLatestExecutions(self.extend(request, params))
        # {
        #   "status": 0,
        #   "data": {
        #     "pagination": {
    ...
    async def fetch_positions(self, symbols=None, since=None, limit=None, params={}):
        ...
        # }
        response = await self.privateGetOpenPositions(self.extend(request, params))
        data = self.safe_value(response, 'data', {})
    ...
    async def edit_order(self, id, symbol, type, side, amount=None, price=None, params={}):
        ...
        response = await self.privatePostChangeOrder(self.extend(request, params))
        # {
        #   "status": 0,
        #   "responsetime": "2019-03-19T01:07:24.557Z"
        # }
...
#           0.9700000000000004]]
        ...
        response = await self.public_get_klines(self.extend(request, params))
        data = self.safe_value(response, 'data', {})
